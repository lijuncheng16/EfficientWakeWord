...
class Conv2dStaticSamePadding(nn.Conv2d):
    ...
    def forward(self, x):
        ...
        #breakpoint()
        #conv = nn.Conv2d(self.in_channels, self.out_channels, self.kernel_size, stride=self.stride, padding=self.padding,
        #                 dilation=self.dilation, groups=self.groups, bias=self.bias, device="mps") 

        #x = flopsConv2d = wrapFunc(F.conv2d, _conv_flops_compute)
